...
import { Terminal, Lock, User, Mail, Eye, EyeOff, AlertCircle, CheckCircle, Code, MapPin, Phone } from "lucide-react"
...
export default function FreelancerSignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Freelancer signup attempt:", formData)
    
    // Store freelancer data in localStorage for simulation
    const userData = {
    ...
    localStorage.setItem('sunntech_freelancer', JSON.stringify(userData))
    
    alert("SUCCESS: Freelancer account initialized! Redirecting to login...")
    setTimeout(() => {
          ...
          <div className="terminal-window p-8 hacker-border">
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="text-2xl font-bold terminal-text glitch mb-2">
                <span className="text-primary">{">"}</span> INITIALIZE_FREELANCER_ACCOUNT
              </h1>
              <p className="text-sm text-muted-foreground terminal-text">
                Create your freelancer profile for secure access to missions
              </p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="fullName" className="block text-sm font-medium mb-2 terminal-text">
                  <span className="text-primary">{">"}</span> FULL_NAME
                </label>
              ...
              <div className="text-center">
                <p className="text-sm text-muted-foreground terminal-text">
                  ...
                  <Link href="/login/freelancer" className="text-primary hover:underline">
                    Authenticate
                  </Link>
                </p>
              </div>
