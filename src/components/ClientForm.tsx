...
import { Terminal, Building2, Mail, Phone, DollarSign, FileText } from 'lucide-react'
    ...
    <Card className="hacker-border terminal-window">
      <CardHeader>
        <CardTitle className="terminal-text flex items-center gap-2">
          ...
          <span className="text-primary">{">"}</span> ADD_CLIENT
        </CardTitle>
        <CardDescription className="terminal-text">
          Add new client information to database
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1 terminal-text">Project Requirements</label>
            <textarea
